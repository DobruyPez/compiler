...
#define FST_BINARY 3,	\
	FST::NODE(4,	\
	FST::RELATION('1', 0), FST::RELATION('0', 0), FST::RELATION('1', 1), FST::RELATION('0', 1)),\
	FST::NODE(1,	\
	FST::RELATION('b', 2)),\
	FST::NODE()
...
#define FST_OCTAL 3,	\
	FST::NODE(16,	\
	FST::RELATION('1', 0), FST::RELATION('2', 0), FST::RELATION('3', 0), FST::RELATION('4', 0), FST::RELATION('5', 0), FST::RELATION('6', 0), FST::RELATION('7', 0), FST::RELATION('0', 0), FST::RELATION('1', 1), FST::RELATION('2', 1), FST::RELATION('3', 1), FST::RELATION('4', 1), FST::RELATION('5', 1), FST::RELATION('6', 1), FST::RELATION('7', 1), FST::RELATION('0', 1)),\
	FST::NODE(1,	\
	FST::RELATION('o', 2)),\
	FST::NODE()
#define FST_DECIMAL 3,	\
	FST::NODE(20,	\
	FST::RELATION('1', 0), FST::RELATION('2', 0), FST::RELATION('3', 0), FST::RELATION('4', 0), FST::RELATION('5', 0), FST::RELATION('6', 0), FST::RELATION('7', 0), FST::RELATION('8', 0), FST::RELATION('9', 0), FST::RELATION('0', 0), FST::RELATION('1', 1), FST::RELATION('2', 1), FST::RELATION('3', 1), FST::RELATION('4', 1), FST::RELATION('5', 1), FST::RELATION('6', 1), FST::RELATION('7', 1), FST::RELATION('0', 1), FST::RELATION('8', 1), FST::RELATION('9', 1)),\
	FST::NODE(1,	\
	FST::RELATION('d', 2)),\
	FST::NODE()
...
#define FST_EQUAL 2,	\
	FST::NODE(1, FST::RELATION('=', 1)),\
	FST::NODE()
#define FST_LEFTWALL 2,	\
	FST::NODE(1, FST::RELATION('[', 1)),\
	FST::NODE()
#define FST_RIGHTWALL 2,	\
	FST::NODE(1, FST::RELATION(']', 1)),\
	FST::NODE()